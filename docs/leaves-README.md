...
| | |
|--------|--------|
| <img width="150" alt="Get started rocket" src="https://github.com/MSFT-SMT-ACCELERATORS/APC-Demo-App/assets/1712635/f738cb51-b237-4b60-9d45-cf976e03c714"> | To **deploy and configure** this example/demo application using APC, refer to this guide: [Deploy the APC example/demo app](leaves-deployment.md) |
